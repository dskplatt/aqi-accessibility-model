...
export default function FindingsPage() {
    return (
        <div className="min-h-screen bg-gray-950 text-white font-sans">
                        ...
                        <ScrollSection delay={100}>
                            <div className="group">
                                <div className="flex items-center gap-4 mb-4">
                                    ...
                                    <div className="h-px flex-grow bg-gray-800 group-hover:bg-accent-start/30 transition-colors" />
                                </div>
            ...
            <footer className="py-12 px-6 border-t border-gray-800 text-center text-gray-500 mt-20">
