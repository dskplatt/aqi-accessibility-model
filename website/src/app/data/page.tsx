    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-gray-900">
      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-16">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
              <ol className="space-y-3 text-gray-300 list-decimal list-inside">
                <li><strong className="text-white">AQI cleaning</strong> — EPA dataset validation, consistency checks, sample weighting</li>
                <li><strong className="text-white">Census cleaning</strong> — Income, race, population, land area (ACS 5-Year Estimates)</li>
                <li><strong className="text-white">Population density</strong> — Total population ÷ land area by county</li>
                <li><strong className="text-white">Region/Division</strong> — U.S. Census Bureau regions and divisions</li>
                <li><strong className="text-white">Joins</strong> — AQI → Income → Race → Density → Region (inner joins on State + County)</li>
                <li><strong className="text-white">Feature engineering</strong> — Log transforms, minority %, density interactions (black_density, minority_density)</li>
              </ol>
            </div>
          </section>
          ...
          {/* Step 1: AQI */}
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">1. AQI Data Cleaning</h2>
            <p className="text-gray-300 mb-4">
              The EPA Access to a Livable Planet dataset provides county-level air quality metrics. We validated uniqueness, consistency of day counts, and removed trailing whitespace. Because some counties have very few monitoring days (e.g., 19), we use <strong className="text-white">sample weighting</strong> instead of excluding them—dropping low-coverage counties would bias our sample toward urban areas. Counties with fewer than 180 days of data are down-weighted proportionally.
            </p>
            <div className="space-y-4">
              <div className="bg-gray-900 rounded-xl border border-gray-700 overflow-hidden">
                <div className="px-4 py-2 bg-gray-800/80 border-b border-gray-700 text-sm text-gray-400 font-mono">
...
df['median_aqi'] = df['Median AQI']  # Our target variable`}
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">2. Median Household Income (ACS S1903)</h2>
            <p className="text-gray-300 mb-4">
...
df.dropna(subset=['Median_Household_Income'], inplace=True)`}
          ...
          {/* Step 3: Census Race */}
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">3. Race by County (ACS DP05)</h2>
            <p className="text-gray-300 mb-4">
...
df.dropna(subset=race_cols, inplace=True)`}
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">4. Population Density</h2>
            <p className="text-gray-300 mb-4">
...
density_df['population_density'] = (
    density_df['Total_Population'] / density_df['Land_Area_SqMi']
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">5. Region & Division</h2>
            <p className="text-gray-300 mb-4">
...
df_joined = df_aqi.merge(
    ...
    on='State', how='left'
          ...
          {/* Step 6: Joins */}
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">6. Joining All Datasets</h2>
            <p className="text-gray-300 mb-4">
...
# Success rate: ~96% (940 / 978 AQI counties matched)`}
          ...
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">7. Feature Engineering</h2>
            <p className="text-gray-300 mb-4">
              Before modeling, we add derived features. <strong className="text-white">Log transforms</strong> (log_population_density, log_median_income) handle skew. <strong className="text-white">total_minority_pct</strong> = 100 − % White. The most important features in our model are <strong className="text-accent-start">black_density</strong> and <strong className="text-accent-start">minority_density</strong>—interactions of race percentages with population density. These capture how racial composition and urbanization jointly relate to air quality.
            </p>
            <div className="bg-gray-900 rounded-xl border border-gray-700 overflow-hidden">
              <div className="px-4 py-2 bg-gray-800/80 border-b border-gray-700 text-sm text-gray-400 font-mono">
...
df['asian_density'] = df['% Asian alone'] * df['population_density'] / 100`}
          ...
          {/* Final Output */}
          <section className="mb-16">
            <h2 className="text-2xl font-bold text-white mb-2">Final Dataset</h2>
            <p className="text-gray-300 mb-4">
              The resulting dataset has <strong className="text-white">942 counties</strong>, <strong className="text-white">39+ features</strong>, and <strong className="text-white">median_aqi</strong> as the target. We use it to train an XGBoost model that predicts air quality from race, income, population density, and geography—demonstrating that clean air is not equally accessible and that exposure is associated with demographic factors.
            </p>
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
              <p className="text-gray-300">
                <strong className="text-white">Key insight:</strong> The model ranks <span className="text-accent-start font-semibold">black_density</span> and <span className="text-accent-start font-semibold">minority_density</span> as the top non-geographic features. This supports our thesis: air quality is systematically related to who lives where—a clear environmental justice signal.
              </p>
            </div>
          </section>
          ...
          <div className="flex gap-4">
            ...
            <Link href="/findings" className="px-6 py-3 bg-gray-800 text-white rounded-full font-medium border border-gray-700 hover:border-gray-600 transition-colors">
              View Findings
            </Link>
          </div>
        </div>
